...
export const WEEK_ORDERS_REQUEST = "WEEK_ORDERS_REQUEST";
export const WEEK_ORDERS_SUCCESS = "WEEK_ORDERS_SUCCESS";
export const WEEK_ORDERS_FAIL = "WEEK_ORDERS_FAIL";

export const MONTH_ORDERS_REQUEST = "MONTH_ORDERS_REQUEST";
export const MONTH_ORDERS_SUCCESS = "MONTH_ORDERS_SUCCESS";
export const MONTH_ORDERS_FAIL = "MONTH_ORDERS_FAIL";
